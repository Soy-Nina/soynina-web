...
export default function UpcomingEvents() {
    ...
    useEffect(() => {
        // Fetch from API and filter to upcoming events
        fetch("/api/events")
            .then((res) => res.json())
            .then((data: EventItem[]) => {
                const now = new Date()
    ...
    return (
        <section className="w-full py-24 bg-[#fafafa]">
            <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
                {/* Section header — editorial style matching Programs */}
                <div className="grid lg:grid-cols-[1fr_2fr] gap-16 mb-16 items-end">
                    <div>
                        <span className="text-[#4526c9] text-sm font-bold tracking-[0.2em] uppercase">Eventos</span>
                    ...
                    <div className="max-w-xl lg:ml-auto">
                        <p className="text-lg text-gray-600 leading-relaxed">
                            Talleres, festivales y jornadas donde nuestras niñas, familias y voluntarias se encuentran para crecer juntas.
                        </p>
                        <a
                            href="/eventos"
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="px-6 pb-6 pt-2 flex flex-col flex-1">
                                    <h3 className="text-xl font-bold text-[#140b3f] mb-2 group-hover:text-[#4526c9] transition-colors">
                                        {event.title}
                                    </h3>
