...
export default function Newsletter() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Build form data for LGL (application/x-www-form-urlencoded)
            ...
            // Submission to LGL
            // Note: LGL returns a 302 redirect on success. 
            // 'no-cors' treats the redirect as a success even if we can't read the response.
            ...
            // We assume success if fetch doesn't throw (no-cors quirk)
            setTimeout(() => {
                setStatus("success")
            }, 800)
        } catch (err) {
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="text-5xl md:text-6xl font-black text-[#140b3f] leading-[1.1] mb-6">
                            Enterate de nuestro<br />
                            <span className="text-[#4526c9]">impacto.</span>
                        </h2>

                        <p className="text-gray-600 text-lg leading-relaxed mb-8 max-w-md">
                            Suscribite para recibir historias de impacto, avances de nuestros programas y
                            oportunidades exclusivas para apoyar a las niñas de Costa Rica.
                        </p>

                        <div className="space-y-4">
                            {[
                                "Reportes de impacto directo",
                                ...
                                <div key={i} className="flex items-center gap-3 text-sm font-medium text-[#140b3f]/70">
                                    <div className="w-5 h-5 rounded-full bg-[#00c49a]/20 flex items-center justify-center text-[#00c49a]">
                                        ✓
                                    </div>
                                    {item}
                                </div>
                        ...
                        <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl shadow-[#4526c9]/10 border border-white relative z-20 overflow-hidden text-left">
                            ...
                            {status === "success" ? (
                                <div className="py-12 flex flex-col items-center text-center animate-in fade-in zoom-in duration-500">
                                    ...
                                    <h3 className="text-2xl font-black text-[#140b3f] mb-2">¡Te damos la bienvenida!</h3>
                                    <p className="text-gray-500 max-w-xs">
                                        Tu suscripción ha sido confirmada. Pronto recibirás noticias nuestras.
                                    </p>
                                    <button
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-2 text-left">
                                            <label htmlFor="firstName" className="text-xs font-bold uppercase tracking-wider text-gray-400 ml-1">
                                                Nombre
                                            </label>
                                            <input
                                                id="firstName"
                                                ...
                                                type="text"
                                                placeholder="Ana"
                                                className="w-full bg-[#f8f4ff] border-2 border-transparent focus:border-[#4526c9]/20 focus:bg-white rounded-2xl px-5 py-4 outline-none transition-all text-[#140b3f] font-medium"
                                                value={formData.firstName}
                                                onChange={(e) => setFormData({ ...formData, firstName: e.target.value })}
                                            />
                                        </div>
                                        <div className="space-y-2 text-left">
                                            <label htmlFor="lastName" className="text-xs font-bold uppercase tracking-wider text-gray-400 ml-1">
                                                Apellido
                                            </label>
                                            <input
                                                id="lastName"
                                    ...
                                    <p className="text-[10px] text-gray-400 text-center leading-relaxed">
                                        ...
                                        Podés darte de baja en cualquier momento desde el pie de cada correo.
                                    </p>
                                </form>
                            )}
                        </div>
